...
// ── paths ─────────────────────────────────────────────────────
// Docker image bakes these in; fallback to /tmp for local dev
const fs_check     = require("fs");
const YTDLP_PATH   = fs_check.existsSync("/usr/local/bin/yt-dlp") ? "/usr/local/bin/yt-dlp" : "/tmp/yt-dlp";
const FFMPEG_PATH  = fs_check.existsSync("/usr/bin/ffmpeg")       ? "/usr/bin/ffmpeg"        : "/tmp/ffmpeg";
const COOKIES_PATH = "/tmp/yt-cookies.txt";
const PLUGIN_DIR   = fs_check.existsSync("/opt/yt-dlp-plugins")   ? "/opt/yt-dlp-plugins"    : "/tmp/yt-dlp-plugins";
